...
export async function fontes(alvo: HTMLElement) {
  ...
  alvo.innerHTML = `<article class="folha">
    ...
    <div class="corpo">
      ...
      <p>${tr(`Os panoramas originais da prancha das regiões e as imagens dos cartões da abertura foram
      ...
      feito para cada uma.`, `The original panoramas on the regions plate and the opening card images were
