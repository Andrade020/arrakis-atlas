  ...
  },
  {
    ...
    passos: [
      ...
      },
      {
        ...
        pt: "Aqui o modelo assinala controle imperial e colheita relevante. A prancha econômica distingue o preço citado no livro da receita de quem colhe.",
        en: "Here the model assigns imperial control and a substantial harvest. The economic plate separates the book's market price from the harvester's income.",
        prancha: "economia",
      },
    ],
  },
